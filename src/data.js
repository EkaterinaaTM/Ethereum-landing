    ...
    features: [
      {
        img: tech,
        title: 'Technolodgy',
        subtitle: 'We are the longest running smart contract blockchain in existence. Blockchains store value. You want your blockchain to last.',
        desc: 'ETC allows highly efficient value transfers (more so than Bitcoin and its variants), has a focus on IoT applications, and runs a mathematically verified Ethereum Virtual Machine, or EVM. What this means is that ETC is great at what it sets out to do: be a highly efficient means of exchange that connects the world’s devices. <br /><br /> Our developer teams are working on the technology and partnerships that will allow for seamless use of the ETC network everywhere blockchain is needed.'
      },
      {
        img: community,
        title: 'Community',
        subtitle: 'We have a strong and principled community. Many of our members have stuck around since the beginning. We look beyond the hype and keep to the principles that keep blockchains functioning.',
